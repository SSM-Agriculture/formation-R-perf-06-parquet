...
## Requêter des données Parquet extérieures (data.gouv) avec Cerise et duckdb (1/4)
...
install.packages("duckdb",
                 repos = "https://packagemanager.posit.co/cran/__linux__/centos8/latest")
...
# Gestion du proxy avec des var. d'environnement
dbExecute(cnx, "
...
## Requêter des données Parquet extérieures (data.gouv) avec Cerise et duckdb (2/4)
...
## Requêter des données Parquet extérieures (data.gouv) avec Cerise et duckdb (3/4)
...
FROM '{dataset}'
WHERE SIREN in ('345149587','388467441','390126209','398066613','402405427','412937682','438833196','452474059','489169664','508473261','509821419',
                 '790465546','852782564','894642347','923272140','947875621','948312806','948407614','948513866','948827449','949061790','949158430','949847420','950824532'
                 ,'951953637','952069854','952688539','982280463')
", .con = cnx)

dbSendQuery(cnx, req)

recup_siren <- dbGetQuery(cnx,"
  SELECT *
  FROM extrait_siren")
...
> recup_siren
# A tibble: 27 × 34
   siren     statutDiffusionUniteLeg…¹ unitePurgeeUniteLegale dateCreationUniteLeg…² sigleUniteLegale sexeUniteLegale prenom1UniteLegale prenom2UniteLegale prenom3UniteLegale
   <chr>     <chr>                     <lgl>                  <date>                 <chr>            <chr>           <chr>              <chr>              <chr>             
 1 390126209 O                         TRUE                   1992-09-01             NA               NA              NA                 NA                 NA                
 2 923272140 O                         NA                     2023-04-01             NA               NA              NA                 NA                 NA                
 3 790465546 O                         NA                     2013-01-01             NA               NA              NA                 NA                 NA                
# ℹ 24 more rows
# ℹ abbreviated names: ¹​statutDiffusionUniteLegale, ²​dateCreationUniteLegale
