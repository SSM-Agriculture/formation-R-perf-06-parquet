...
La fonction `duckdb_register()` permet de charger dans duckdb des données présentes dans la session R.  
...
# Database: DuckDB v1.1.0 [damien.dotta@Windows 10 x64:R 4.3.0/:memory:]
 ...
 6 1577526     3                  1         2           1    0101030406 EXH_GEO    10       97407          LA RIVIERE DES GAL…
 7 1577527     3                  1         2           1    0101030406 EXH_GEO    10       97407          LA RIVIERE DES GAL…
 8 1577528     3                  1         2           1    0101030406 EXH_GEO    10       97407          LA RIVIERE DES GAL…
 9 1577533     1                  1         1           0    NA         NA         10       28393          CHENE CHENU        
10 1577534     2                  1         1          12.0  2402815003 2402815003 10       28393          NA                 
# ℹ more rows
# ℹ 245 more variables: SIEGE_LIEUDIT_CODE_DOM <chr>, SIEGE_LIB_COM <chr>, SIEGE_DEP <chr>, SIEGE_LIB_DEP <chr>,
```
