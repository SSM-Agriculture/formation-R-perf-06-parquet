...
## La fonction `open_dataset()` (2/3)

La fonction `open_dataset()` crée un objet qui apparaît dans Values. 

![](img/vue_values.png){fig-align="center"}

L’affichage dans la console d’un Arrow Table affiche uniquement des métadonnées (nombre de lignes et de colonnes, nom et type des colonnes).
