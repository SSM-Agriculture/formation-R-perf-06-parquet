...
## Forcer les types des colonnes lors de l'écriture de fichiers Parquet (1/2)
...
schema <- schema(colonne1 = int32(), colonne2 = utf8(), colonne3 = boolean()) 
...
## Forcer les types des colonnes lors de l'écriture de fichiers Parquet (2/2)
