...
<br>
Une autre façon de forcer le typage des colonnes est d'utiliser un `schema`. Cependant, cela apporte de la complexité au code pas forcément utile. En cas de besoin, un exemple est disponible sur [cette page](https://gist.github.com/ddotta/d3900a8c7d2d247a90de6f8c6a261172).
